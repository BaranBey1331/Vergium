 ...
 */
public final class VulkanFastPath implements DispatchPipeline {
    private int indirectBufferId;
    private CommandBuffer activeCommands;
    private boolean prepared;
    private int lastUploadedCommandCount;
    ...
    public void render(int bufferId, int vertexCount) {
        ...
        if (activeCommands != null && !activeCommands.isEmpty()) {
            ...
            lastUploadedCommandCount = activeCommands.getCommandCount();
        }
    }
    ...
    public int getLastUploadedCommandCount() {
        return lastUploadedCommandCount;
    }
